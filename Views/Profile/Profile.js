...
const Profile = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.container3}>
                <View style={[styles.container2, {borderRightWidth: 2,}]}>
                <Image style={{ height: 120, width: 130,}} source={{ uri: 'https://media.newyorker.com/photos/59776d0672c5e854a512693d/2:2/w_1028,h_1028,c_limit/Hsu-Monkey-Videos-as-a-Way-of-Life.jpg' }}></Image>
            ...
            <View style={styles.container3}>
                ...
                <View style={styles.container2}>
                <Image style={{ height: 120, width: 130,}} source={{ uri: 'https://th-thumbnailer.cdn-si-edu.com/nBS-pC9IPPIMNCEiK_BaZNGdWh0=/1000x750/filters:no_upscale()/https://tf-cmsv2-smithsonianmag-media.s3.amazonaws.com/filer/38/ee/38ee7aaa-abbb-4c60-b959-4b1c5c8c6989/axgpay.jpg' }}></Image>
